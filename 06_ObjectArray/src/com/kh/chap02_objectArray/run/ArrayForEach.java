...
public class ArrayForEach {
	...
	public static void main(String[] args) {
		...
		/*
		 * 모두 주소값이 다르다
		System.out.println(phones); 		// phones[0 ~ 2]를 담고 있는 방
		System.out.println(phones[0]); 		// phones 0번 방에 들어있는 방
		System.out.println(phones[1]); 		// phones 1번 방에 들어있는 방
		System.out.println(phones[2]); 		// phones 2번 방에 들어있는 방
		*/
