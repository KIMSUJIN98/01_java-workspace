...
public class A_Array {
	...
	public void method4() {
		...
		for(int i=0; i<arr.length; i++) { // 동적으로 변하도록 하드코딩하지 않는다(i<5)
			System.out.println(arr[i]);
		}
	...
	public void method7() {
		...
		System.out.println(arr1[1] == arr2[1]); //true (인덱스 값 비교)
	...
	public void method9() {
		...
		for(int i =0; i<arr.length; i++) {
			...
			arr[i] = fruit;
			*/
			arr[i] = sc.nextLine(); // 'String arr[i] = '같은 실수x
		}
	...
	public void method10() {
		...
		*/
		...
		// 4. 반복문 활용해서 해당배열의 0~ 마지막 인덱스까지 담긴 값 출력
	...
	public void method99() {
		...
		String[] arr1 = new String[] {"1,2,3,4","가나다"};
		String[] arr2 = {"1,2,3,4","가나다"};
		
		System.out.println(arr1 == arr2); //false
		System.out.println(arr1.equals(arr2)); //false arr1의 주소랑 arr2의 주소랑 같은가? false
