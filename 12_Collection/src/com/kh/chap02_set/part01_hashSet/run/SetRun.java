...
public class SetRun {
	...
	public static void main(String[] args) {
		...
		System.out.println(hs2); // 저장 순서 유지안됨!!(인덱스 개념 없음) / 중복제거 안됨 => 왜? 동일객체로 판단이 안되고 있어서..!
		...
		// 1. for문 사용 가능 (단, 향상된 for문(for each문) 만 가능!!)											// 일반 for문은 인덱스 값을 써줘야하기에 쓸 값이 없다
		...
		//it.next(); 더 이상 뽑을 요소가 없음 NoSuchElementException 발생
