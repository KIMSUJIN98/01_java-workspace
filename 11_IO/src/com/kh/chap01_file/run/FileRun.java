...
public class FileRun {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// 폴더만들기
			File tempFolder = new File("D:\\temp"); 				// temp : 임시적인
			tempFolder.mkdir();										// makeDirectory
			...
			System.out.println("절대경로 : " + file.getAbsolutePath()); 					// 정확한 주소값, Absolute : 절대
	 ...
	 * 			=> 입력과 출력을 동시다발적으로 하고자 한다면? 입력용스트림 / 출력용스트림 따로 만들어야됨!!
