...
public class ElectronicRun {
	...
	public static void main(String[] args) {
		...
		// 객체를 생성해서 넣어두기 위해 우선 es를 생성!!!
		// 객체를 생성하는 순간 해당 클래스에 제시된 세 필드가 메모리 상에 할당
		
		// 메소드를 써서 생성하겠음
		// 먼저 필요한 메소드를 생각해보자
		
		// 아직은 없는 메소드
		// 추가용(생성용) 메소드 => insert (규율적, 관례적)
		// 데스크탑 이라는 객체를 생성해서 넘기는 메소드
		
		// es.insert(데스크탑 이라는 객체를 생성);
		es.insert(new Desktop("Sansung", "데땁", 1200000, "Gtx1070"));
		...
		*/
		...
		/*
		Desktop d = (Desktop)es.select(0); 			// es.select(0) 전체를 형변환
		...
		*/
		...
		//System.out.println(d);
		// 위아래 둘다 가능								// 위는 명시적으로 보다 확실하게 Desktop, NoteBook, Tablet만을 받는다.
