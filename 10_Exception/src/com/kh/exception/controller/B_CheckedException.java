...
public class B_CheckedException {
	...
	public void method1() { // 여기서도 떠넘길 수 있음 => 끝까지 떠넘기면 JVM이 처리 : 권장X 							// 여기서도 떠넘기면 ExceptionRun.java로 넘어가게 된다.
		//method2();
	...
	public void method2() throws IOException {
		...
		*/
		...
		String str = br.readLine(); 																	// throws IOException를 추가함으로써 Unhandled exception type IOException 에러가 안남 => 대신 method1에서 에러 발생
