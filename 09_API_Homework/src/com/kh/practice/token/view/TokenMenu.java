...
public class TokenMenu {
	...
	public void tokenMenu() {
		...
		String after_str = tc.afterToken(str);
		System.out.println("토큰 처리 후 글자 : " + after_str);
		System.out.println("토큰 처리 후 개수 : " + after_str.length());
		System.out.println("모두 대문자로 변환 : " + after_str.toUpperCase());
	}
	...
	public void inputMenu() {
		...
		String after_input = tc.firstCap(input);
		System.out.println("첫 글자 대문자 : " + after_input);
