...
public class E_Logical {
	...
	public void method3() {
		...
		// 성별을 입력해주세요 (M/F) : gender 라는 변수 선언해서 입력받아보기
	...
	public void method4() {
		...
		// 논리 연산자 앞의 선행 조건의 결과에 따라 증감연산자의 작용 여부가 달라지거나 Dead code가 발생할 수 있다.
	...
	public void method5() {
		...
		// 사용자가 입력한 값이 y 또는 Y입니까? (true, false 중에 하나가 뜨도록 짜보세요)	=>	result
