...
public class NonStaticMethod {
	 ...
	 *  공통 : 낙타표기법(camel case)
	 *  
	 *  접근제한자 반환형(반환할 값의 자료형) 메소드명([매개변수1, 매개변수2, ....]) { 	// public void method1(){...}
	 *  	수행내용;
	 *  	[return 결과값;] void일때 빼고 	// 반환형이 void인 경우 제외하고는 return 결과값; 필요
	 *  
	 *  }
	 *  
	 */
	...
	public void method1() {
		//return 0; => 반환할 값 없어야 한다!!	//사용불가 But. return;은 가능하다 : 메소드를 빠져나가는 리턴으로 기능이 다르다.
	...
	// apple 전달받아서 2번인덱스 뽑아줘 하면 p가 나와야함
