...
public class AbstractionRun {
	 ...
	 * 		: 클래스라는 틀을 먼저 만들어야 됨!!! (클래스란 ? 각 객체들의 속성(정보)들을 담아낼 그릇 같은 존재) => 이름, 나이, 주소, 휴대폰번호 등등을 담을 수 있는 그릇
	 ...
	 * 		최수연라는 학생 객체를 만들어내기 위해서는? --> String name3 = "최수연"; int age3 = 22; double height3 = 150.7;
	 ...
	 *		Student 라는 클래스로 만들꺼임!! => 객체의 정보를 보관할 그릇과도 같은 이런 클래스들은 => model.vo	// vo : value object
	 *
	 *
	 */
	...
	public static void main(String[] args) {
		...
		System.out.println(woo); // 이상함 : 주소값 출력		// com.kh.chap01_abstraction.model.vo.Student@5aaa6d82 : @ 앞은 자료형을, @ 뒤는 16진수의 주소값을 나타냄
